            ...
            <div class="d-flex align-items-center">
                ...
                // Alternating Blue vs Black and Brown bins
                {
                    match get_alternate_bin() {
                        ...
                        BinVariation::None => html! { <BinSVG color="blue" /> }
                    }
                }

                // Christmas tree icon during collection period
                if show_christmas_tree {
                    <div class="fs-1" style="margin-left: 10px;">{"🎄"}</div>
                }
...
fn BinSVG(&BinSVGProps { ref color }: &BinSVGProps) -> Html {
    html! {
        <svg xmlns="http://www.w3.org/2000/svg" fill="white" height="80px" width="74px" viewBox="16 0 268 300">
            <path fill={color.clone()} d="M221.74,94.57L207.98,259.6c-0.79,9.51-8.88,16.95-18.42,16.95h-82.12 c-9.53,0-17.63-7.44-18.42-16.95L75.27,94.57H221.74z"/>
            <path fill={color.clone()} d="M239.49,65.69v8.43H57.51v-8.43c0-6.32,5.14-11.47,11.47-11.47h159.05 C234.35,54.22,239.49,59.37,239.49,65.69z"/>
